...
export const dqmIdentity = () => {
  return (
    <div className="dqmidentity ">
      <div className="text-wrapper">How do you identify?</div>
      <div className="div">
        <img
          className="image"
          alt="Image"
        ...
        />
        <div className="text-wrapper-2"><Link href="/demoquestions/dqmAge">Back</Link></div>
      </div>
      <a href = "/demoquestions/dqmEthnicity">
